...
import { selectActiveSortItem } from '../redux/slices/filterSlice';

export const SortLabel: React.FC = () => {
  const sotrItems: string[] = ['цене', 'без мяса', 'хит', 'премиум', 'постные', 'алфавиту'];
  ...
  return (
    <div ref={sortRef} className="sort">
      <div className="sort__label">
        ...
        <b>Сортировка по:</b>
        <span onClick={() => setVisible(!isVisible)}>{sotrItems[activeSortItem]}</span>
      </div>
      {isVisible && (
